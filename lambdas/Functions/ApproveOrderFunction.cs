...
namespace PrintingShopLambdas
{
    ...
    /// Marks order as ReadyToPrint (approval by shop owner)
    /// </summary>
    public class ApproveOrderFunction
    {
        ...
        public ApproveOrderFunction()
        {
            ...
            _logger = factory.CreateLogger<ApproveOrderFunction>();
        }
        ...
        public async Task<APIGatewayProxyResponse> HandleAsync(APIGatewayProxyRequest request, ILambdaContext context)
        {
            try
            {
                _logger.LogInformation("ApproveOrder Lambda invoked");
                ...
                var response = new ApiResponse(
                    Success: true,
                    Message: "Order approved and marked as ReadyToPrint");
            ...
            {
                _logger.LogError(ex, "Error in ApproveOrder Lambda");
